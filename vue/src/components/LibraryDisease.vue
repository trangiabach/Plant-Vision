...
export default {
    ...
    methods: {
        ...
        onFileChanged() {
            ...
            .then(res => {
                ...
                this.prediction.result = res.data.result
        ...
        getDisease() {
            axios.post("http://127.0.0.1:5000/disease", {
                name: this.$route.params.librarydisease
            })
            .then(res => {
                this.prediction.url = res.data.image
                this.prediction.result = res.data.result
    ...
    mounted() {
        console.log(this.$route.params.librarydisease)
        this.getDisease()
    }
}
</script>
